...
module.exports = createCoreController('api::text.text', ({strapi}) => ({
    ...
    createHighlightedText: async (ctx, next) => {
        try {
            ...
            const data = await strapi.service("api::text.text").createHighlightedText(body, params, userId);
    ...
    getHighlightedTextById: async (ctx, next) => {
        try {
            ...
            const data = await strapi.service("api::text.text").getHighlightedTextById(body, params, userId);
